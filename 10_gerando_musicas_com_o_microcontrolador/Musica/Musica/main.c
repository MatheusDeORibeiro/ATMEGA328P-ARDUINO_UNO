...
{
	"e,e,e,8c,16p,16g,e,8c,16p,16g,e,p,b,b,b,8c6,16p,16g,d#,8c,16p,16g,e,8p" //Marcha Imperial - Star Wars
	//"32p,c.6,e6,f#6,8a6,g.6,e6,c6,8a,8f#,8f#,8f#,2g" //Simpsons
};
//------------------------------------------------------------------------------------
int main()
{
	unsigned int k;
	unsigned char o, d, j, n, i = 0;
