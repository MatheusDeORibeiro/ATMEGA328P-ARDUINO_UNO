...
#define PORT_DADOS PORTC //define o barramento de dados
#define DIR_DADOS  DDRC  //define a direção do barramento de dados
#define LE_DADOS   PINC  //define a leitura do barramento de dados
...
#define _slc_nibble 0x00 //1 para o nibble mais significativo e 0 para o nibble menos significativo
