...
#define TC0_modo_pwm_fc_TOP_OC0A 0x05 //modo pwm com fase corrigida com valor TOP igual a OC0A
#define TC0_modo_pwm_r_TOP_OC0A  0x07 //modo pwm rápido com valor TOP igual a 255
