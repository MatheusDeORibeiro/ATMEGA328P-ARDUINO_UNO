...
#define TC0_OC0A_normal 0b00111111 //modo normal, CTC e pwm rápido: desconecta OC0A
#define TC0_OC0A_toggle 0b01111111 //modo normal, CTC e pwm rápido(WGM02 = 1): muda estado de OC0A na igualdade da comparação
#define TC0_OC0A_n_inv  0b10111111 //modo normal, CTC e pwm rápido: limpa OC0A na igualdade da comparação, modo não-invertido
#define TC0_OC0A_inv    0b11111111 //modo normal, CTC e pwm rápido: seta OC0A na igualdade da comparação, modo invertodo

#define TC0_OC0B_normal 0b11001111 //modo normal, CTC e pwm rápido: desconecta OC0B
#define TC0_OC0B_toggle 0b11011111 //modo normal: muda estado  de OC0B na igualdade da comparação
#define TC0_OC0B_n_inv  0b11101111 //modo normal, CTC e pwm rápido: limpa OC0B na igualdade da comparação, modo não-invertido
#define TC0_OC0B_inv    0b11111111 //modo normal, CTC e pwm rápido: seta OC0B na igualdade da comparação, modo invertido
