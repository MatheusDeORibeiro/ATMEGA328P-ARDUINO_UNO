...
#define LE_DADOS   PIND  //define a leitura do barramento de dados
#define PORT_CONT  PORTB //define o barramento de controle
#define DIR_CONT   DDRB  //define a direção do barramento de controle 
#define _EN        PB1   //define o pino enable
#define _RW        PB2   //define o pino leitura/escrita
#define _RS        PB3   //define o pino dado/instrução

//macro para seleção do nibble mais ou menos significativo
#define _slc_nibble 0x01 //1 para o nibble mais significativo e 0 para o nibble menos significativo
...
//macros para decodificação de um número inteiro para digitos individuais

#define _tam_vetor    5           //define a quantidade de digitos máxima
#define _valor_decod 48           //valor correspondente à tabela ascii: 48 e valor normal: 0
